...
class YOLOv1DataLoader(DataLoader):
    ...
    def make_label(self, boxes, labels):
        ...
        label_dim = self.n_boxes_per_grid * 5 + self.n_classes
        label_shape = [self.grid_size, self.grid_size, label_dim]
        ...
        targets = tf.reshape(targets, shape=[1, num_objects, label_dim])
