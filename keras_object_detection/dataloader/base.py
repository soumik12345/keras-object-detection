...
class DataLoader(ABC):
    ...
    def get_tfrecord_files(self):
        train_tfrecord_pattern = os.path.join(
            self.dataset_path, "tfrecords", "train", "*"
        )
        val_tfrecord_pattern = os.path.join(self.dataset_path, "tfrecords", "val", "*")
    ...
    def build_dataset(
        self, batch_size: int = 16, buffer_size: int = 512, is_train: bool = False
    ):
